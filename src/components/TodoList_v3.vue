...
export default {
    ...
    created(){
        ...
        for(let i=0; i<this.localStorageLength; i++){
            ...
            this.dynamicLists.push(localStorage.key(i))
            }
        }
    },
    computed:{
    ...
    methods:{
        ...
        toggleDestroyed(idx){
            if(this.isCompletedArr[idx]){
                this.isCompletedArr[idx] = false;
                this.isCompleted = false;
            }
            localStorage.removeItem(this.dynamicLists[idx])
            console.log(this.dynamicLists.length)
            console.log(this.dynamicLists.splice(idx,1))
        },
